...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Enter the Title of the book', max_length=50, unique=True)),
                ('summary', models.TextField(help_text='enter summary for the book ', max_length=1000, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a Book Genre ex(fiction, romance, adventure, poetry, acedemic ) etc ...', max_length=200, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the language in which the book is written ex(french, english, german, amharic, tigrigna, oromic, arabic)', max_length=30, unique=True)),
            ],
            options={
